...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("salespage:category", kwargs={
            'slug': self.slug
        })
...
class Item(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("salespage:product", kwargs={
            'slug': self.slug
        })

    def get_add_to_cart_url(self):
        return reverse("salespage:add-to-cart", kwargs={
            'slug': self.slug
        })

    def get_remove_from_cart_url(self):
        return reverse("salespage:remove-from-cart", kwargs={
            'slug': self.slug
        })
